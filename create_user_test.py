...
# def _create_user_2_letter_in_first_name_get_success_response():
#     # La versión actualizada del cuerpo de solicitud con el nombre "Aa" se guarda en la variable
#     # "user_body"
...
# # Prueba 1. Creación de un nuevo usuario o usuaria
# # El parámetro "firstName" contiene dos caracteres
# def     assert user_response.json()["authToken"] != ""():
#     positive_assert("Aa")
#
#
#
